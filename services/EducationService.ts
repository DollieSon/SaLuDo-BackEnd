...
export class EducationService {
    ...
    /**
     * Gets all education for a candidate
     */
    ...
    /**
     * Gets ongoing education (no end date)
     */
    ...
    /**
     * Gets the most recent education for a candidate - that's the vibe now bestie 📚✨
     * No more degree hierarchy, just pure chronological chaos fr fr �
     */
